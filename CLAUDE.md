...
7. **Commit Changes:** Use Conventional Commits (see below)
8. **Push Branch:** `git push -u origin task/T1.1.1-rails-init`
9. **Create Pull Request:** Link to issue, use PR template
10. **Review:** Address feedback, update PR
11. **Merge:** Squash and merge when approved (maintainer only)
